...
const Header = ({ session, loading }) => {
  ...
  return (
    <div className="w-full font-sans select-none border-b border-[#1e4635]/60 bg-[#060b18]">
      ...
      <header className="max-w-7xl mx-auto h-20 px-4 md:px-8 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center space-x-3.5 group cursor-pointer">
          <div className="relative">
            ...
            <img
              ...
              className="relative w-12 h-12 rounded-full object-cover border-2 border-[#10b981] shadow-lg transform group-hover:scale-105 transition duration-200"
            />
          </div>
          <div className="flex flex-col">
            <div className="flex items-center space-x-2">
              <span className="font-extrabold text-white text-lg tracking-tight group-hover:text-emerald-400 transition">
                EIC PEC CHANDIGARH
              </span>
            ...
            <span className="text-xs text-slate-400 font-medium">
              Entrepreneurship & Incubation Cell • Punjab Engineering College
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center space-x-3">
          <div className="hidden lg:flex items-center space-x-2 text-xs font-semibold text-emerald-400 bg-[#163b2c]/60 border border-[#10b981]/40 px-3 py-1.5 rounded-xl">
            <Sparkles size={14} className="text-[#f49f1c]" />
            <span>E-Summit AI Evaluation Live</span>
          </div>
        </div>
      </header>
    </div>
